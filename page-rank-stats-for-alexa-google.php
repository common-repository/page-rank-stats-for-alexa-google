...
Plugin URI: https://heartytools.com/guide/alexa-and-google-page-rank-plugin-for-websites/
...
<?php
		    	...
		    	?>
		    	<a href="https://www.alexa.com/siteinfo/<?php echo $alexatype; ?>"><script type="text/javascript" src="https://xslt.alexa.com/site_stats/js/t/a?url=<?php echo $alexatype; ?>"></script></a>
		    	<?php
		    }

		    else if($alexastyle == 'medium'){
		    	?>
		    	<a href="https://www.alexa.com/siteinfo/<?php echo $alexatype; ?>"><script type="text/javascript" src="https://xslt.alexa.com/site_stats/js/s/a?url=yoursite.com"></script></a>
		    	<?php
		    }

		    else if($alexastyle == 'vertical'){
		    	?>
		    	<a href="https://www.alexa.com/siteinfo/<?php echo $alexatype; ?>"><script type="text/javascript" src="https://xslt.alexa.com/site_stats/js/s/b?url=<?php echo $alexatype; ?>"></script></a>
		    	<?php
		    }		    
